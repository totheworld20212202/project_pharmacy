...
class DirectionServiceTest extends Specification {
                                    ...
                                    // unitTest이므로 spring container가 안띄어짐 그래서, Mocking 처리함.
    private PharmacySearchService pharmacySearchService = Mock()    // pharmacySearchService만 주입받는 단위테스트를 위한 mocking
    ...
    def "buildDirectionList - 결과 값이 거리 순으로 정렬이 되는지 확인"(){
        ...
        pharmacySearchService.searchPharmacyDtoList() >> pharmacyList   // .searchPharmacyDtoList()라는 method가 불릴때 위에 정의한 pharmacyList를 리턴해라.
